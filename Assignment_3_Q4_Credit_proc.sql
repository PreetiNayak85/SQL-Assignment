CREATE DEFINER=`root`@`localhost` PROCEDURE `Assignmt_3_Q4_credit_proc`(cus_num integer)
BEGIN
...
if climit < 100000 and p_stat = "platinum" then set new_climit = 100000;
signal sqlstate '45000';
elseif climit > 60000 and p_stat = "silver" then set new_climit = 60000;
signal sqlstate '45000';
end if;
END