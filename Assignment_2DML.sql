CREATE TABLE if not exists employee1 (empid integer, fname varchar(30), lname varchar(30), deptno integer, salary decimal(10,2));
INSERT INTO employee1 VALUES (100,'Jon','Hamm',10,2000.00),
                           (200,'Tom','Cruise', 10, 3000.00),
                           (300,'Hugh','Laurie',20,7500.00),
                           (400,'Tom','Hanks',30,750.00),      
                           (500,'Johnny','Depp', 20, 1300.00),
                           (600,'Hugh','Grant',30,850.00),
                           (700,'Ben','Affleck',30,75.00),
                           (800,'George','Clooney',10,10000.00),
                           (900,'Henry',Null, 10, 3000.00),
                           (1000,'Gregory','House',20,3500.00),
                           (1100,'Jean','Hackman',10,2700.00);
DESC employee1;
SELECT*from employee1;
SELECT * FROM employee1 WHERE deptno=10 AND salary >3000.00;
...
CREATE TABLE IF NOT EXISTS station (id int(11) DEFAULT NULL, 
...
INSERT INTO station VALUES (794,'Kissee Mills','MO',139.65,73.42),
                            ...
                            (447,'Arkadelphia','AR',98.62,49.58),(498,'Glen','IL',60.84,140.72),(351,'Fredericksburg','IN',44.51,78.06),
                            (774,'Manchester','IA',129.67,123.30),(116,'Mc Henry','MD',93.29,112.56),(963,'Eriline','KY',93.62,65.44),
                            (643,'Wellington','KY',100.45,31.69),(781,'Hoffman','IL',129.40,53.42),(364,'Howard','MN',125.76,78.33),
                            (777,'Edgewater','MD',130.07,72.29),(15,'Ducor','CA',140.86,102.04),(910,'Salem','KY',86.98,113.96),
                            (612,'Sturdivant','MO',93.84,86.39),(537,'Hagatna','GU',97.17,151.81),(970,'East','CT',115.68,132.38),
                            (510,'Eastlake','MI',134.09,38.78),(354,'Larkspur','CA',107.05,65.97),(983,'Patriot','IN',82.64,46.08),
                            (799,'Corriganville','MD',141.38,153.65),(581,'Carlos','MN',114.91,66.28),(825,'Addison','MI',96.37,142.41),
                            (526,'Tarzana','CA',135.86,81.31),(176,'Grapevine','AR',92.37,84.54),(994,'Kanorado','KS',65.42,85.72),
                            (704,'Climax','MI',127.36,107.05),(582,'Curdsville','KY',84.79,150.48),(884,'Southport','CT',59.09,63.13),
                            (196,'Compton','IL',106.62,99.41),(605,'Notasulga','AL',66.84,115.69),(430,'Rumsey','KY',70.69,50.21),
                            (234,'Rogers','CT',140.47,33.18),(700,'Pleasant','AR',135.14,145.59),(702,'Everton','MO',119.05,51.49),
                            (662,'Skanee','MI',70.17,129.56),(171,'Springerville','AZ',124.69,150.66),(615,'Libertytown','MD',144.58,111.97),
                            (26,'Church','MD',39.43,91.26),(692,'Yellow','ID',83.12,150.89),(336,'Dumont','MN',57.01,129.37),
                            (464,'Gales','CT',104.57,37.41),(315,'Ravenna','KY',79.15,106.25),(505,'Williams','AZ',73.48,111.74),
                            (842,'Decatur','MI',63.31,161.42),(982,'Holbrook','AZ',134.88,103.86),(868,'Sherrill','AR',79.96,152.22),
                            (554,'Brownsdale','MN',52.43,50.80),(199,'Linden','MI',53.41,32.62),(453,'Sedgwick','AR',68.93,75.29),
                            (451,'Fort','IA',142.86,140.64),(950,'Peachtree City','GA',80.49,155.98),(326,'Rocheport','MO',114.16,64.48),
                            (189,'West','KY',73.97,45.06),(638,'Clovis','CA',92.44,138.08),(156,'Heyburn','ID',82.09,121.05),
                            (861,'Peabody','KS',75.42,152.21),(722,'Marion','AL',53.32,31.34),(428,'Randall','KS',48.00,135.63),
                            (677,'Hayesville','IA',119.99,42.13),(183,'Jordan','MN',68.75,35.46),
                            (322,'\"White Horse	Beach\"','MA',54.29,59.32),(827,'Greenville','IL',50.64,153.02),
                            (242,'Macy','IN',138.69,152.37),(621,'Flowood','MS',64.89,149.21),(960,'Deep','IA',75.37,38.57),
                            (180,'Napoleon','IN',32.03,160.24),(382,'Leavenworth','IN',100.43,121.73),
                            (853,'Coldwater','KS',47.51,26.31),(105,'Weldon','CA',134.02,118.96),(357,'Yellville','AR',35.69,42.25),
                            (710,'Turners','MA',31.09,125.09),(520,'Delray','FL',27.29,158.52),(920,'Eustis','FL',42.74,39.48),
                            (684,'Mineral','MO',91.20,41.43),(355,'Weldona','CO',32.97,58.45),(389,'Midpines','CA',106.43,59.38),
                            (303,'Cascade','ID',31.77,157.48),(501,'Tefft','IN',93.22,150.02),(673,'Showell','MD',44.19,163.54),
                            (834,'Bayville','ME',106.73,143.41),(255,'Brighton','IL',107.61,32.85),(595,'Grimes','IA',42.05,74.73),
                            (709,'Nubieber','CA',132.90,49.28),(100,'North','ME',130.95,78.17),(522,'Harmony','MN',124.36,126.37),
                            (16,'Beaufort','MO',71.77,85.66),(231,'Arispe','IA',31.11,137.80),(923,'Union','MO',79.07,132.66),(891,'Humeston','IA',74.51,122.42),(165,'Baileyville','IL',82.25,61.45),(757,'Lakeville','CT',59.87,94.99),(506,'Firebrick','KY',49.99,95.04),
                            (76,'Pico','CA',143.28,116.53),(246,'Ludington','MI',30.22,120.23),(583,'Channing','MI',117.16,56.95),
                            (666,'West Baden Springs','IN',30.35,96.11),(373,'Pawnee','IL',85.23,81.42),(504,'Melber','KY',37.25,55.53),
                            (901,'Manchester','MN',71.02,84.01),(306,'Bainbridge','GA',62.05,56.88),(821,'Sanders','AZ',130.50,96.78),
                            (586,'Ottertail','MN',100.02,44.34),(95,'Dupo','IL',41.28,29.03),(524,'Montrose','CA',136.48,119.37),
                            (716,'Schleswig','IA',119.25,51.88),(849,'Harbor','MI',141.30,148.86),(611,'Richmond','IL',113.25,163.46),
                            (904,'Ermine','KY',119.64,62.80),(740,'Siler','KY',137.02,117.25),(439,'Reeves','LA',35.25,51.40),
                            (57,'Clifton','AZ',30.15,135.70),(155,'Casco','MI',138.60,109.07),(755,'Sturgis','MI',117.39,135.40),
                            (11,'Crescent','FL',58.04,117.90),(287,'Madisonville','LA',112.22,53.05),(435,'Albion','IN',44.26,121.88),
                            (672,'Lismore','MN',58.87,103.87),(572,'Athens','IN',75.32,120.80),(890,'Eufaula','AL',140.30,103.09),
                            (975,'Panther','MS',116.51,164.52),(914,'Hanscom','MA',129.19,136.41),(119,'Wildie','KY',69.66,111.86),
                            (540,'Mosca','CO',89.20,141.48),(678,'Bennington','IN',35.52,26.80),(208,'Lottie','LA',109.87,82.77),
                            (512,'Garland','ME',108.73,134.38),(352,'Clutier','IA',61.19,127.03),(948,'Lupton','MI',139.93,53.36),
                            (503,'Northfield','MN',61.00,37.15),(288,'Daleville','AL',121.89,136.17),(560,'Osage City','KS',110.20,89.61),
                            (479,'Cuba','MO',63.72,87.65),(826,'Norris','MT',47.19,37.26),(651,'Clopton','AL',40.77,84.71),
                            (143,'Renville','MN',142.15,99.43),(240,'Saint','KS',66.21,163.01),(102,'Kirksville','MO',140.00,143.87),
                            (69,'Kingsland','AR',78.22,85.14),(181,'Fairview','KS',80.27,164.58),(175,'Lydia','LA',41.78,39.53),
                            (80,'Bridgton','ME',93.23,140.42),(596,'Brownstown','IL',48.65,63.22),(301,'Monona','IA',144.13,81.58),
                            (987,'Hartland','MI',136.26,107.74),(973,'Andover','CT',51.74,52.53),(981,'Lakota','IA',56.15,92.39),(440,'Grand','CA',37.31,126.59),(110,'Mesick','MI',82.12,108.53),(396,'Dryden','MI',69.80,47.74),(637,'Beverly','KY',57.75,126.90),(566,'Marine On Saint Croix','MN',126.16,115.79),(801,'Pocahontas','IL',109.63,83.23),(739,'Fort','FL',43.99,35.30),(130,'Hayneville','AL',109.74,157.47),(345,'Yoder','IN',83.50,143.72),(851,'Gatewood','MO',76.32,145.67),(489,'Madden','MS',81.34,99.38),(223,'Losantville','IN',112.52,106.78),(538,'Cheswold','DE',31.94,59.35),(329,'Caseville','MI',102.92,98.40),(815,'Pomona','MO',52.33,50.28),(789,'Hopkinsville','KY',27.32,47.95),(269,'Jack','AL',49.94,85.63),(969,'Dixie','GA',27.22,36.47),(271,'Hillside','CO',99.27,68.84),(667,'Hawarden','IA',90.96,46.93),(350,'Cannonsburg','MI',91.03,120.67),(49,'Osborne','KS',70.36,139.71),(332,'Elm','LA',45.94,29.40),(172,'Atlantic','MI',131.23,99.47),(699,'North','CT',37.80,95.27),(417,'New','IA',139.96,94.60),(99,'Woodstock','CT',117.39,162.63),
                            (404,'Farmington','IL',91.71,72.02),(23,'Honolulu','HI',110.10,139.74),(1,'Pfeifer','KS',37.44,65.68),(127,'Oshtemo','MI',100.37,135.95),(657,'Gridley','KS',118.15,55.80),(261,'Fulton','KY',111.11,51.93),(182,'Winter','FL',133.23,32.76),(328,'Monroe','LA',28.36,108.42),(779,'Del','CA',59.18,95.77),(646,'Greens','IN',133.92,135.48),(756,'Garden','AL',96.08,105.42),(157,'Blue','KY',116.96,162.00),(400,'New','IN',134.02,120.95),(61,'Brilliant','AL',86.44,159.85),(610,'Archie','MO',40.20,28.20),(985,'Winslow','AR',126.14,126.12),(207,'Olmitz','KS',29.24,38.40),(941,'Allerton','IA',61.84,112.50),(70,'Norphlet','AR',144.02,61.19),(343,'Mechanic','ME',71.67,71.12),(531,'North','KY',42.99,141.91),(996,'Keyes','CA',76.97,85.61),(167,'Equality','AL',106.98,116.06),(750,'Neon','KY',101.98,147.67),(410,'Calhoun','KY',95.60,56.90),(725,'Alpine','AR',116.82,114.65),(988,'Mullan','ID',143.30,154.67),(55,'Coalgood','KY',57.17,149.02),(640,'Walnut','MS',40.94,76.96),(302,'Saint','FL',51.71,119.86),(387,'Ojai','CA',68.61,119.33),(476,'Julian','CA',130.51,101.56),(907,'Veedersburg','IN',78.90,94.85),(294,'Orange','FL',59.22,137.31),(661,'Payson','AZ',126.30,154.16),(745,'Windom','KS',114.19,126.39),(631,'Urbana','IA',142.53,29.35),(356,'Ludlow','CA',110.99,87.59),
                            (419,'Lindsay','MT',143.10,67.84),(494,'Palatka','FL',94.55,52.33),(625,'Bristol','ME',87.97,95.29),(459,'Harmony','IN',135.02,70.83),(636,'Ukiah','CA',86.98,89.58),(106,'Yuma','AZ',111.33,153.95),(204,'Alba','MI',91.64,103.63),(344,'Zachary','LA',60.71,152.49),(599,'Esmond','IL',75.55,90.92),(515,'Waresboro','GA',144.25,153.61),(497,'Hills','MN',137.97,134.77),(162,'Montgomery','MO',70.44,44.67),(499,'Delavan','MN',32.58,64.51),(362,'Magnolia','MS',112.74,31.80),(545,'Byron','CA',136.51,120.42),(712,'Dundee','IA',61.60,105.04),(257,'Eureka','AR',72.06,34.78),(154,'Baker','CA',31.05,148.46),(715,'Hyde','MA',65.09,156.24),(493,'Groveoak','AL',53.39,87.51),(836,'Kenner','LA',91.74,126.57),(82,'Many','LA',36.28,94.73),(644,'Seward','AK',120.29,35.71),(391,'Berryton','KS',60.73,139.76),(696,'Chilhowee','MO',79.61,49.36),(905,'Newark','IL',72.53,129.89),(81,'Cowgill','MO',136.80,27.64),(31,'Novinger','MO',108.04,111.91),(299,'Goodman','MS',101.44,117.28),(84,'Cobalt','CT',87.32,26.53),(754,'South','MI',144.66,52.79),(144,'Eskridge','KS',107.63,63.49),(305,'Bennington','KS',93.87,83.24),(226,'Decatur','MS',71.25,117.57),(224,'West','MA',58.96,96.01),(694,'Ozona','FL',144.99,120.88),(623,'Jackson','AL',111.23,67.24),(543,'Lapeer','MI',128.62,114.26),(819,'Peaks','ME',59.14,110.69),(243,'Hazlehurst','MS',49.03,108.50),(457,'Chester','CA',69.81,123.93),(871,'Clarkston','MI',93.94,80.54),
                            (470,'Healdsburg','CA',111.10,54.22),(705,'Hotchkiss','CO',69.90,71.82),(690,'Ravenden','AR',67.63,108.26),(62,'Monroe','AR',131.90,150.22),(365,'Payson','IL',81.74,92.11),(922,'Kell','IL',70.36,58.74),(838,'Strasburg','CO',89.40,47.89),(286,'Five','AL',45.66,122.22),(968,'Norris','IL',53.67,76.11),(928,'Coaling','AL',144.26,52.21),(746,'Orange','IA',93.53,162.95),(892,'Effingham','KS',132.95,97.72),(193,'Corcoran','CA',81.30,139.56),(225,'Garden','IA',54.21,119.91),(573,'Alton','MO',79.78,112.04),(830,'Greenway','AR',119.27,35.99),(241,'Woodsboro','MD',76.63,141.89),(783,'Strawn','IL',29.68,51.09),(675,'Dent','MN',70.75,136.78),(270,'Shingletown','CA',61.12,102.10),(378,'Clio','IA',46.15,115.42),(104,'Yalaha','FL',120.38,119.69),(460,'Leakesville','MS',107.17,72.58),(804,'Fort','CO',38.50,93.39),(53,'Shasta','CA',99.32,155.61),(448,'Canton','MN',123.64,151.42),(751,'Agency','MO',59.28,95.68),(29,'South','KY',58.00,116.96),(718,'Taft','CA',107.86,146.74),(213,'Calpine','CA',46.51,43.28),(624,'Knobel','AR',95.35,62.09),(908,'Bullhead','AZ',94.83,30.43),(845,'Tina','MO',131.70,28.12),(685,'Anthony','KS',45.01,161.13),(731,'Emmett','ID',57.10,31.53),(311,'South','MN',30.50,87.13),(866,'Haverhill','IA',61.83,109.17),
                            (598,'Middleboro','MA',108.05,149.29),(541,'Siloam','GA',105.02,92.23),(889,'Lena','LA',78.16,129.62),(654,'Lee','IL',27.67,51.01),
                            (841,'Freeport','MI',113.55,50.96),(446,'Mid','FL',110.41,50.75),
                            (249,'Acme','LA',73.16,67.68),(376,'Gorham','KS',111.32,64.75),
                            (136,'Bass','ME',137.67,61.33),(455,'Granger','IA',33.42,102.08),
                            (136,'Bass Harbor','ME',137.67,61.33),(455,'Granger','IA',33.42,102.08);
SELECT* FROM station;
...
SELECT * FROM emp;
SELECT * FROM emp WHERE salary >2000 and hire_date >= now()-interval 10 month ORDER BY emp_no ASC;
SELECT * FROM emp WHERE(salary>2000 and hire_date <10)ORDER BY emp_no ASC;

SELECT * FROM employee1;
SELECT deptno, (SUM(salary)) FROM employee1 GROUP BY deptno;

CREATE TABLE IF NOT EXISTS city (id int(11) DEFAULT NULL,
